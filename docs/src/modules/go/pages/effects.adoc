...
This page documents how to use Cloudstate effects and forwarding in Go. For high level information on what Cloudstate effects and forwarding is, please read the general xref:concepts:effects.adoc[forwarding and effects] documentation first.

== Looking up service call references GOON
